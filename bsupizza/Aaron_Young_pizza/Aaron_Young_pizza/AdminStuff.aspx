<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminStuff.aspx.cs" Inherits="Aaron_Young_pizza.AdminStuff" %>
...
<body class="has-drawer">
    ...
    <div class="col-md-6 col-md-offset-4">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="Pizza_Thanks_GVsource">
            <Columns>
        ...
        <asp:SqlDataSource ID="Pizza_Thanks_GVsource" runat="server" ConnectionString="<%$ ConnectionStrings:pizzaDB %>" SelectCommand="SELECT * FROM [ContactLog] ORDER BY [Time]"></asp:SqlDataSource>
    </div>
