<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeliveryInfo.aspx.cs" Inherits="Aaron_Young_pizza.DeliveryInfo" %>
...
<body class="has-drawer">
    ...
    <header class="container">
        <nav class="collapse navbar-collapse navbar-inverse">
            ...
            <ul class="nav navbar-nav" id="navBar">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-localize="nav.options" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span>Options</span><span class="caret" /></span></a><span class="caret" />
                    <ul class="dropdown-menu">
    ...
    <div class="col-md-6 col-md-offset-3">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="DeliveryInfo_GVsource">
            <Columns>
        ...
        <asp:SqlDataSource ID="DeliveryInfo_GVsource" runat="server" ConnectionString="<%$ ConnectionStrings:pizzaDB %>" SelectCommand="SELECT [Address_Type], [Phone], [AddressLine1], [AddressLine2], [ZipCode] FROM [Delivery_Address] WHERE ([UserName] = @UserName)">
            <SelectParameters>
